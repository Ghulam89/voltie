...
import { manHoldingPhone  ,staytuned,blackbg} from '@/assets/images'
const AppPage = () => {
    return (
        <section className='relative h-full w-full overflow-hidden'>  
        <Image src={staytuned} layout='fill' objectFit='cover' alt='slider-image-first'/>  
             ...
             <div className='flex w-full content-center justify-cente h-full'>
                ...
                {/* <Image src={staytuned} alt='details-section-image-first' 
                        objectFit='contain'
                        style={{ height: "35%"}}
                    /> */}
               </div>
