          ...
          <div className=" pb-7 z-10 text-white w-full h-full sm:h-max ">
            <div className="px-[5%] sm:px-[15%] gap-y-56 w-full h-full flex justify-center items-center">
              <div className="  flex flex-col justify-center  items-center">
                ...
                <div className="flex justify-center items-center gap-2 md:gap-x-4 flex-wrap md:flex-nowrap mt-2"></div>
                <Description
                ...
                <div className="flex justify-between pt-10  w-full sm:flex-row md:flex-row  md:items-start">
                  <div className="w-[50%] ">
                    ...
                    <div className="flex">
                      <span>⚡</span>
                      <p className="pb-2">
                        Multi communications (Wi-Fi/Bluetooth<br></br>
                        /Ethernet).
                      </p>
                    </div>
                  ...
                  <div className="w-[50%]">
                    <Image
                      src={charger}
                      alt="level-two-charger"
                      className=" w-[50%] h-[50%] hidden lg:block"
                    ></Image>
                  </div>
                </div>
                {/* ---------------------------------------------------------------------------------- */}
