        ...
        <section className='h-[100vh]  w-full pt-[15%] sm:pt-[8%] bg-[#f1f1e6]'>
            <div className='w-[100%] h-full bg-[#f1f1e6] lg:gap-x-8 p-2 md:p-5'>
                <div className='px-[5%] text-black flex flex-col gap-y-8 h-full '>
                    ...
                    <Heading name="Title of section" color='black' />
                    <SubHeading name="Lorem ipsum dolor sit amet consectetur adipisicing elit." color='black' />
                    <Description name="1.2 million additional private chargers are needed by 2030 to support the electric vehicle market.Lorem ipsum dolor sit amet consectetur, adipisicing elit."
                        color='black'
                    />
                    </div>
                    <Slider
                    {...settings}>
                    {
                        ...
                        >
                            <div className="flex gap-3 items-center mb-2">
                                <span>✅</span>
                                <div>
                                    <h2 className="mb-2 text-2xl font-bold text-black">Feature</h2>
                                </div>
                            </div>
